...
const hrConfig: StringKeyMap = {
    ...
    FINALITY_SCAN_OFFSET_LEFT: Number(ev('FINALITY_SCAN_OFFSET_LEFT', 300)),
    FINALITY_SCAN_OFFSET_RIGHT: Number(ev('FINALITY_SCAN_OFFSET_RIGHT', 16)),
    FINALITY_SCAN_CHUNK_SIZE: Number(ev('FINALITY_SCAN_CHUNK_SIZE', 30)),
    FINALITY_SCAN_ITERATION_DELAY: Number(ev('FINALITY_SCAN_ITERATION_DELAY', 100)),
    MAX_DEPTH_BEFORE_REORG_NOTIFICATION: Number(ev('MAX_DEPTH_BEFORE_REORG_NOTIFICATION', 100)),
    DROPPED_CONNECTION_CHECK_INTERVAL: 30000, // 30s
    MAX_TIME_GAP_UNTIL_AUTO_RECONNECT: 60 // 1 min
}
