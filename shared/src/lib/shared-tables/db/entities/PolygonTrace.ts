...
export enum PolygonRewardType {
    Block = 'block',
    Uncle = 'uncle',
}

export enum PolygonTraceStatus {
    Failure = 0,
    Success = 1,
}
 ...
 * A Polygon Trace.
 */
@Entity('traces', { schema: schemas.polygon() })
export class PolygonTrace {
