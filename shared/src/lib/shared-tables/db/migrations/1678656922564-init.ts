...
export class init1678656922564 implements MigrationInterface {
    name = 'init1678656922564'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE "polygon"."traces"`)
        await queryRunner.query(`DROP TABLE "polygon"."transactions"`)
        await queryRunner.query(`DROP TABLE "polygon"."contracts"`)
