...
export class namespaceAccessTokens1686703012724 implements MigrationInterface {
    name = 'namespaceAccessTokens1686703012724'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "namespace_access_tokens" ("id" SERIAL NOT NULL, "uid" character varying NOT NULL, "namespace_id" integer NOT NULL, "scopes" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "expires_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "PK_ec66669f28f11aff40b2ab12053" PRIMARY KEY ("id"))`
        )
        await queryRunner.query(
